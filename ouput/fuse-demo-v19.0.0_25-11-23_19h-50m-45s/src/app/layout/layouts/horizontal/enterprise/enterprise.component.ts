...
import { FuseFullscreenComponent } from '@tropi/components/fullscreen';
import { FuseLoadingBarComponent } from '@tropi/components/loading-bar';
import { FuseHorizontalNavigationComponent, FuseNavigationService, FuseVerticalNavigationComponent } from '@tropi/components/navigation';
...
export class EnterpriseLayoutComponent implements OnInit, OnDestroy
{
    ...
    {
        // Get the navigation
        const navigation = this._tropiNavigationService.getComponent<FuseVerticalNavigationComponent>(name);
