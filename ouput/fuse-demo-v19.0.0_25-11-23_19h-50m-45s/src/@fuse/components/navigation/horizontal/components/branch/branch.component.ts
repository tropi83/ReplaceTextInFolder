...
import { FuseHorizontalNavigationBasicItemComponent } from '@tropi/components/navigation/horizontal/components/basic/basic.component';
import { FuseHorizontalNavigationDividerItemComponent } from '@tropi/components/navigation/horizontal/components/divider/divider.component';
...
@Component({
    selector       : 'tropi-horizontal-navigation-branch-item',
