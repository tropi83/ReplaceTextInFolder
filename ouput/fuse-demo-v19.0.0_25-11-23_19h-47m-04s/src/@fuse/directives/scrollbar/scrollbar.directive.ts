...
import { ScrollbarGeometry, ScrollbarPosition } from '@tropi/directives/scrollbar/scrollbar.types';
 ...
 */
@Directive({
    selector  : '[tropiScrollbar]',
    exportAs  : 'tropiScrollbar',
    standalone: true,
})
export class FuseScrollbarDirective implements OnChanges, OnInit, OnDestroy
{
    /* eslint-disable @typescript-eslint/naming-convention */
    static ngAcceptInputType_tropiScrollbar: BooleanInput;
    /* eslint-enable @typescript-eslint/naming-convention */

    @Input() tropiScrollbar: boolean = true;
    @Input() tropiScrollbarOptions: PerfectScrollbar.Options;
    ...
    {
        // Enabled
        if ( 'tropiScrollbar' in changes )
        {
            // Interpret empty string as 'true'
            this.tropiScrollbar = coerceBooleanProperty(changes.tropiScrollbar.currentValue);

            // If enabled, init the directive
            if ( this.tropiScrollbar )
            {
                this._init();
            }
        ...
        // Scrollbar options
        if ( 'tropiScrollbarOptions' in changes )
        {
            // Merge the options
            this._options = merge({}, this._options, changes.tropiScrollbarOptions.currentValue);
