...
export class LayoutComponent implements OnInit, OnDestroy
{
    ...
    constructor(
        ...
        private _tropiConfigService: FuseConfigService,
        private _tropiMediaWatcherService: FuseMediaWatcherService,
        private _tropiPlatformService: FusePlatformService,
    )
    {
    }
    ...
    ngOnInit(): void
    {
        ...
        combineLatest([
            this._tropiConfigService.config$,
            this._tropiMediaWatcherService.onMediaQueryChange$(['(prefers-color-scheme: dark)', '(prefers-color-scheme: light)']),
        ]).pipe(
        ...
        // Set the app version
        this._renderer2.setAttribute(this._document.querySelector('[ng-version]'), 'tropi-version', FUSE_VERSION);

        // Set the OS name
        this._renderer2.addClass(this._document.body, this._tropiPlatformService.osName);
    }
