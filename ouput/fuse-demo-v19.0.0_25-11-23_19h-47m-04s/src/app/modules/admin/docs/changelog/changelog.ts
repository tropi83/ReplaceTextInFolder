            ...
            changes    : [
                {
                    type: 'Fixed',
                    list: [
                        '(@tropi/confirmation-dialog) Fixed: Extra padding on the confirmation dialogs',
                    ],
                },
            ],
        },
            ...
            changes    : [
                {
                    ...
                    list: [
                        ...
                        '(.tropi-mat-textarea) Removed in favor of CSS :has selector, now textareas within "mat-form-field" components are detected automatically',
                        '(.tropi-mat-no-subscript) Removed in favor of \'subscriptSizing="dynamic"\' property of "mat-form-field"',
                    ],
                },
                {
                    type: 'Changed',
        ...
        // v15.2.0
        {
            ...
            changes    : [
                ...
                },
                {
                    type: 'Fixed',
                    list: [
                        '(@tropi/tailwind/plugins/theming) Simplified the plugin and added more detailed comments',
        ...
        // v15.1.0
        {
            ...
            changes    : [
                ...
                },
                {
                    type: 'Fixed',
                    list: [
                        '(@tropi/overrides/angular-material) mat-hint position is not working correctly on fields',
                    ],
                },
            ],
        },
            ...
            changes    : [
                {
                    type: 'Added',
                    list: [
                        '(@tropi/navigation) Added "fragment" and "queryParams" support along with "preserveFragment" and "queryParamsHandling" on navigation items',
                        '(@tropi/overrides/quill) Added tooltip styles for better compatibility',
                        '(@tropi/services/platform) Added platform checker service',
                ...
                },
                {
                    ...
                    list: [
                        ...
                        '(@tropi/overrides/quill) Better scrolling for Quill editor',
                ...
                },
                {
                    type: 'Fixed',
                    list: [
                        '(@tropi/navigation) Collapse animation doesn"t work smoothly because of the parent"s margin',
                        '(@tropi/service/confirmation) Cleaned-up the dialog component',
            ...
            changes    : [
                {
                    ...
                    list: [
                        ...
                        '(@tropi/navigation) Expose the width variables as css custom properties, so they can be overridden from the outside',
                        '(@tropi/drawer) Expose the width variable as a css custom property, so it can be overridden from the outside',
                        '(@tropi/masonry) Removed the unnecessary scss file',
                    ],
                },
                {
                    type: 'Fixed',
        ...
        // v14.0.0
        {
            ...
            changes    : [
                ...
                },
                {
                    type: 'Fixed',
                    list: [
                        '(@tropi/overrides/angular-material) Fixed: Normal border color of the text field overrides the invalid and focus border colors on dark themes',
                        '(@tropi/navigation) Don\'t need to use interpolation on scss variables anymore since Tailwind doesn\'t cause any problems with them anymore',
                    ],
                },
            ],
        },
        ...
        // v13.6.0
        {
            ...
            changes    : [
                ...
                },
                {
                    type: 'Fixed',
                    list: [
                        '(@tropi/drawer) Final opacity of the overlay is not permanent due to player being destroyed right after the animation',
                    ],
                },
            ],
        },
            ...
            changes    : [
                {
                    ...
                    list: [
                        ...
                        '(@tropi/theming) Better structuring on the themes.scss file',
                        '(@tropi) Disabled Angular Material "theme" sanity check since we use "all-component-themes" without a color map',
                ...
                },
                {
                    type: 'Fixed',
                    list: [
                        '(@tropi/overrides) Quill editor is not styled correctly by default',
                        '(@tropi/confirmation) Dialog size cannot be updated using dialogRef\'s "updateSize" method',
            ...
            changes    : [
                {
                    type: 'Fixed',
                    list: [
                        '(tropi/confirmation) Confirmation dialog colors are not optimized for the Dark mode',
                    ],
                },
            ],
        },
            ...
            changes    : [
                {
                    type: 'Added',
                    list: [
                        '(tropi/confirmation) A service to quickly configure and show confirmation dialogs',
                    ],
                },
                {
                    type: 'Changed',
            ...
            changes    : [
                {
                    type: 'Added',
                    list: [
                        '(tropi/navigation) "tooltip" property to show tooltips on navigation items using MatTooltip',
                    ],
                },
                {
                    type: 'Changed',
                    list: [
                        ...
                        '(tropi/navigation) Moved *ngIf directives into their own "ng-container" containers',
                        '(layouts) Hide the "tropi-fullscreen" button on smaller devices since they don\'t support fullscreen',
                ...
                },
                {
                    type: 'Fixed',
                    list: [
                        '(tropi/drawer) Memory leak due to the animation player, thanks to Vadym Pidoplichko for coming up the issue and the solution.',
                        '(tropi/navigation) Vertical navigation blocks scroll if it\'s destroyed while in "over" mode and opened',
            ...
            changes    : [
                {
                    type: 'Added',
                    list: [
                        '(tropi/fullscreen) [tooltip] & [iconTpl] inputs for customizing the trigger button',
                        '(tropi/navigation) "target" property for setting the target attribute on external links',
                ...
                },
                {
                    type: 'Fixed',
                    list: [
                        '(tropi/navigation) First children of collapsable items don\'t have proper spacing at the top',
        ...
        // v13.0.3
        {
            ...
            changes    : [
                ...
                },
                {
                    type: 'Changed',
                    list: [
                        '(tropi/autogrow) BREAKING: Removed "tropiAutogrow" in favor of "matTextareaAutosize" since all of its problems solved, use [matTextareaAutosize] without any vertical padding on the textarea itself',
            ...
            changes    : [
                {
                    ...
                    list: [
                        ...
                        '(tropi/masonry) Added a component for creating fast Masonry-like layouts',
                    ],
                },
                {
                    type: 'Changed',
            ...
            changes    : [
                {
                    ...
                    list: [
                        ...
                        '(tropi/fullscreen) Added fullscreen toggle component',
                    ],
                },
                {
                    type: 'Changed',
