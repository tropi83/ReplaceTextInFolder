...
import { FuseFindByKeyPipe } from '@tropi/pipes/find-by-key/find-by-key.pipe';
...
export class TasksDetailsComponent implements OnInit, AfterViewInit, OnDestroy
{
    ...
    constructor(
        ...
        private _tropiConfirmationService: FuseConfirmationService,
    ...
    deleteTask(): void
    {
        ...
        const confirmation = this._tropiConfirmationService.open({
            title  : 'Delete task',
