...
import { FuseVerticalNavigationComponent } from '@tropi/components/navigation';
...
@Component({
    ...
    template     : `
        <div class="py-10">
            ...
            <tropi-vertical-navigation
                [appearance]="'default'"
                [navigation]="menuData"
                [inner]="true"
                [mode]="'side'"
                [name]="'demo-sidebar-navigation'"
                [opened]="true"></tropi-vertical-navigation>
    ...
    styles       : [
        `
            demo-sidebar tropi-vertical-navigation .tropi-vertical-navigation-wrapper {
