...
import { FuseDrawerService } from '@tropi/components/drawer/drawer.service';
import { FuseDrawerMode, FuseDrawerPosition } from '@tropi/components/drawer/drawer.types';
import { FuseUtilsService } from '@tropi/services/utils/utils.service';

@Component({
    selector     : 'tropi-drawer',
    templateUrl  : './drawer.component.html',
    styleUrls    : ['./drawer.component.scss'],
    encapsulation: ViewEncapsulation.None,
    exportAs     : 'tropiDrawer',
    standalone   : true,
})
export class FuseDrawerComponent implements OnChanges, OnInit, OnDestroy
{
    ...
    constructor(
        ...
        private _tropiDrawerService: FuseDrawerService,
    ...
    @HostBinding('class') get classList(): any
    {
        /* eslint-disable @typescript-eslint/naming-convention */
        return {
            'tropi-drawer-animations-enabled'         : this._animationsEnabled,
            'tropi-drawer-fixed'                      : this.fixed,
            'tropi-drawer-hover'                      : this._hovered,
            [`tropi-drawer-mode-${this.mode}`]        : true,
            'tropi-drawer-opened'                     : this.opened,
            [`tropi-drawer-position-${this.position}`]: true,
        };
        /* eslint-enable @typescript-eslint/naming-convention */
    }
    ...
    {
        // Register the drawer
        this._tropiDrawerService.registerComponent(this.name, this);
    }
    ...
    ngOnDestroy(): void
    {
        ...
        this._tropiDrawerService.deregisterComponent(this.name);
    }
    ...
    private _showOverlay(): void
    {
        ...
        this._overlay.classList.add('tropi-drawer-overlay');

        // Add a class depending on the fixed option
        if ( this.fixed )
        {
            this._overlay.classList.add('tropi-drawer-overlay-fixed');
        }

        // Add a class depending on the transparentOverlay option
        if ( this.transparentOverlay )
        {
            this._overlay.classList.add('tropi-drawer-overlay-transparent');
        }
