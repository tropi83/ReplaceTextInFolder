...
@Component({
    selector       : 'tropi-horizontal-navigation-basic-item',
...
export class FuseHorizontalNavigationBasicItemComponent implements OnInit, OnDestroy
{
    ...
    )
    {
        ...
        this.isActiveMatchOptions = this._tropiUtilsService.subsetMatchOptions;
    }
    ...
    ngOnInit(): void
    {
        ...
        this.isActiveMatchOptions =
            this.item.isActiveMatchOptions ?? this.item.exactMatch
                ? this._tropiUtilsService.exactMatchOptions
                : this._tropiUtilsService.subsetMatchOptions;
