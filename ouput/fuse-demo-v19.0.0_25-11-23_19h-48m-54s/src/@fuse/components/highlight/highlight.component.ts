...
import { FuseHighlightService } from '@tropi/components/highlight/highlight.service';

@Component({
    selector       : 'textarea[tropi-highlight]',
    templateUrl    : './highlight.component.html',
    styleUrls      : ['./highlight.component.scss'],
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'tropiHighlight',
    standalone     : true,
    imports        : [NgClass],
})
export class FuseHighlightComponent implements OnChanges, AfterViewInit
{
    ...
    constructor(
        ...
        private _tropiHighlightService: FuseHighlightService,
    ...
    private _highlightAndInsert(): void
    {
        ...
        this.highlightedCode = this._domSanitizer.sanitize(SecurityContext.HTML, this._tropiHighlightService.highlight(this.code, this.lang));
