...
export class TasksListComponent implements OnInit, OnDestroy
{
    ...
    ngOnInit(): void
    {
        ...
        this._tasksService.tasks$
            ...
            .subscribe((tasks: Task[]) =>
            {
                ...
                setTimeout(() =>
                {
                    ...
                    const mainNavigationComponent = this._tropiNavigationService.getComponent<FuseVerticalNavigationComponent>('mainNavigation');

                    // If the main navigation component exists...
                    if ( mainNavigationComponent )
                    {
                        const mainNavigation = mainNavigationComponent.navigation;
                        const menuItem = this._tropiNavigationService.getItem('apps.tasks', mainNavigation);
        ...
        this._tropiMediaWatcherService.onMediaQueryChange$('(min-width: 1440px)')
            .pipe(takeUntil(this._unsubscribeAll))
            .subscribe((state) =>
            {
