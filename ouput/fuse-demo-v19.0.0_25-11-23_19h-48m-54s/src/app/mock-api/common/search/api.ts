...
import { FuseNavigationItem, FuseNavigationService } from '@tropi/components/navigation';
...
export class SearchMockApi
{
     ...
     */
    constructor(
        private _tropiMockApiService: FuseMockApiService,
    ...
    registerHandlers(): void
    {
        ...
        const flatNavigation = this._tropiNavigationService.getFlatNavigation(this._defaultNavigation);
